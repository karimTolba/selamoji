                      ...
                      <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown">
                          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span id="service"><i class="fas fa-user-cog"></i> Services</span>
                          </a>
                          <div class="dropdown-menu service" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="#">Service_1</a>
                            <a class="dropdown-item" href="#">Service_2</a>
                            <a class="dropdown-item" href="#">Service_3</a>
                          </div>
                        </li>
                        <li class="nav-item">
        ...
        <footer>
            ...
            <div class="conainer-fluid">
                    ...
                    <div id="copy_right">
                        ...
                        <div class="text-center copy_rights">
                            <div class="card-body">
                                <P><em>&COPY;</em> Reserved to www.selamoji.com</P>
                                <P>
                                    <a id="privacy_policy" href="{{route('selamoji_privacy_policy_page')}}">Terms + privacy policy</a>
                                </P>
                            </div>
                        </div>
                    </div>
